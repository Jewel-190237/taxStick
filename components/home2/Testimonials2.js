    ...
    <section className='mt-40'>
      <div className="service mt-8 md:mt-10 lg:mt-[50px] max-w-[1320px] mx-auto px-4 lg:px-0">
        <div className='flex items-center justify-between'>
          <div>
            <p className='testimonials2'> TESTIMONIAL</p>
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center md:gap-5 lg:gap-6">
          {testimonialsDate.map((data) => (
            <TestimonialsCard2 key={data.rate} name={data.name} title={data.title} image={data.image} rate={data.rate} speech={data.speech} />
          ))}
        </div> */}
      </div>
    </section>
